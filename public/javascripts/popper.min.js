...
(function (e, t) {
    ...
    function g(e, o) {
        var i = ie(), r = 'HTML' === o.nodeName, p = u(e), s = u(o), d = n(e), a = t(o),
        ...
        if (c.marginTop = 0, c.marginLeft = 0, !i && r) {
            var g = +a.marginTop.split('px')[0], b = +a.marginLeft.split('px')[0];
    ...
    function b(e) {
        var t = e.ownerDocument.documentElement, o = g(e, t), i = J(t.clientWidth, window.innerWidth || 0),
        ...
        modifiers: {
            ...
            arrow: {
                order: 500, enabled: !0, fn: function (e, o) {
                    ...
                    var n = e.placement.split('-')[0], r = e.offsets, p = r.popper, s = r.reference,
                        ...
                        f = l.toLowerCase(), m = d ? 'left' : 'top', c = d ? 'bottom' : 'right', u = O(i)[a];
                    s[c] - u < p[f] && (e.offsets.popper[f] -= p[f] - (s[c] - u)), s[f] + u > p[c] && (e.offsets.popper[f] += s[f] + u - p[c]);
                    var g = s[f] + s[a] / 2 - u / 2, b = t(e.instance.popper, 'margin' + l).replace('px', ''),
                ...
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    return p.forEach(function (s, d) {
                        ...
                        var a = e.offsets.popper, l = e.offsets.reference, f = X,
                            ...
                            c = f(a.left) < f(o.left), h = f(a.right) > f(o.right), u = f(a.top) < f(o.top),
            ...
            computeStyle: {
                order: 850, enabled: !0, fn: function (e, t) {
                    ...
                    var s, d, a = void 0 === p ? t.gpuAcceleration : p, l = r(e.instance.popper), f = u(l),
                    ...
                    if (d = 'bottom' == h ? -f.height + c.bottom : c.top, s = 'right' == g ? -f.width + c.right : c.left, a && b) m[b] = 'translate3d(' + s + 'px, ' + d + 'px, 0)', m[h] = 0, m[g] = 0, m.willChange = 'transform'; else {
                        var y = 'bottom' == h ? -1 : 1, w = 'right' == g ? -1 : 1;
